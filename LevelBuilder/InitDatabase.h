...
{
	RGP_CORE::Class_DB::addClass("Model3D", (void*(*)(void** args)) (&RGP_CORE::Model3D::Create));
	//RGP_CORE::Class_DB::addClass("PointLight", (void*(*)(void** args)) (&RGP_CORE::PointLight::Create));
	//RGP_CORE::Class_DB::addClass("SpotLight", (void*(*)(void** args)) (&RGP_CORE::SpotLight::Create));
	RGP_CORE::Class_DB::addClass("DirectionnalLight", (void*(*)(void** args)) (&RGP_CORE::DirectionnalLight::Create));
